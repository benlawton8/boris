...
# 📋 The Boris file (copy all of this)

Make a new file at `~/.claude/agents/boris.md` and paste in everything in the box below.
...
*Source of truth + updates: github.com/benlawton8/boris*
